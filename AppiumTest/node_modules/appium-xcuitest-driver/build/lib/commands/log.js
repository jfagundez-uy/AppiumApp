...
const SUPPORTED_LOG_TYPES = {
    ...
    server: {
        ...
        getter: (self) => {
            ...
            return logger_1.default.unwrap().record.map((x) => (0, helpers_1.toLogEntry)(lodash_1.default.isEmpty(x.prefix) ? x.message : `[${x.prefix}] ${x.message}`, 
    ...
    async startLogCapture() {
        ...
        if (lodash_1.default.isUndefined(this.logs.syslog)) {
            ...
            if (lodash_1.default.isBoolean(this.opts.showSafariConsoleLog)) {
                this.logs.safariConsole = new safari_console_log_1.default({
                    showLogs: this.opts.showSafariConsoleLog,
                    log: this.log,
                });
            }
            if (lodash_1.default.isBoolean(this.opts.showSafariNetworkLog)) {
                this.logs.safariNetwork = new safari_network_log_1.default({
